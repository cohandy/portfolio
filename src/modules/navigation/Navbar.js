    ...
    render() {
        ...
        return (
            <nav className="navbar">
                ...
                <a href="https://bitbucket.org/cohandy/" className={currentBlock.navColor === "#FFFFFF" ? "navbar_link" : "navbar_link navbar_link--black"} style={textStyles} target="_blank" rel="noopener noreferrer">BITBUCKET</a>
