      ...
      blocks: [
        ...
        },
        {
          ...
          details: {
            ...
            description: "My second project with AtScale was replacing their old documentation platform with a new custom solution using Node.js and Express.js. The platform uses the file system to generate routes based on folder names and hierarchy. A key feature is version inheritance, any version inherits the files/docs of the previous versions, reducing redundancy for writers. The docs themselves use ReStructuredText for markup, with a few custom features like include statements and themed callouts. All of this and not to mention HTML to PDF generation for each page and version, building out jenkins pipelines for automated deployments, and the entire API reference pages based on the openapi spec. This project was a ton of fun and equally challenging. Please ask me more if you’re interested!"
          }
        },
        {
          name: "ENTERPRISE",
